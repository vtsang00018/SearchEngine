...
//        }
        ...
        {
            Path imagePath = Paths.get("/Users/aishanibhalla/Development/SearchEngine/src/main/data/faulkner.jpg");
//            System.out.println("Found file");
            LabelApp app = new LabelApp(getVisionService());
            List<EntityAnnotation> labels = app.labelImage(imagePath, MAX_LABELS);
            String searchTerm = "";
            for (EntityAnnotation label : labels) {
                searchTerm += (label.getDescription()) + " ";
            }
            System.out.println("Faulkner.jpg");
...
//            printLabels(System.out, imagePath, app.labelImage(imagePath, MAX_LABELS));
        ...
        {
            Path imagePath = Paths.get("/Users/aishanibhalla/Development/SearchEngine/src/main/data/pikachu.png");
//            System.out.println("Found file");
            LabelApp app = new LabelApp(getVisionService());
            List<EntityAnnotation> labels = app.labelImage(imagePath, MAX_LABELS);
            String searchTerm = "";
            ...
            System.out.println("Pikachu.png");
            ArrayList<String> query = parser.parse_text(searchTerm);
        ...
        {
            Path imagePath = Paths.get("/Users/aishanibhalla/Development/SearchEngine/src/main/data/cat.jpg");
//            System.out.println("Found file");
            LabelApp app = new LabelApp(getVisionService());
            List<EntityAnnotation> labels = app.labelImage(imagePath, MAX_LABELS);
            String searchTerm = "";
...
//    public static ArrayList<String> labels(Path imagePath, List<EntityAnnotation> labels)
    /**
